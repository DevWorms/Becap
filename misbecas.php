          ...
          <div class="row">
            ...
            <div class="col-md-9">
                    ...
                    <div class="col-md-2 col-md-offset-1 caja caja-azul">
                      <div class="col-xs-9 space-inside" align="left">
                        ...
                        <div class="space-inside-p">
                            ...
                            <div align="center">
                              <button class="btn btn-danger">Notificar a la escuela</button>  
                            </div>
                            
                        </div>
                      </div>
                      <div class="col-xs-3" align="right">
                        <span class="gr"><b>100%</b></span>
                      </div>
                    </div>  

                    <div class="col-md-2 col-md-offset-1 caja">
                      <div class="col-xs-9 space-inside" align="left">
                        <a href="" data-toggle="modal" data-target="#tecmon"><span class="blue-box">Universidad Metropolitana de Monterrey</span></a>
                        <div class="space-inside-p">
                      ...
                      <div class="col-xs-3" align="right">
                        ...
                        <strong class="blue">80%</strong>  
                      </div>
                    </div>

                    <div class="col-md-2 col-md-offset-1 caja">
                      <div class="col-xs-9 space-inside" align="left">
                        <a href="" data-toggle="modal" data-target="#tecmon"><span class="blue-box">Tec Milenio</span></a>
                        <div class="space-inside-p">
                            <br>
                            <p><b>Beca Académica</b></p>
                            <p>50% de Beca sobre colegiatura</p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 col-md-offset-1 caja-2">
                      <div class="col-xs-9 space-inside" align="left">
                    ...
                    <div class="col-md-2 col-md-offset-1 caja-2">
                      <div class="col-xs-9 space-inside" align="left">
                        <a href="" data-toggle="modal" data-target="#tecmon"><span class="blue-box">UDEM</span></a>
                        <div class="space-inside-p">
                            <br>
                            <p><b>Beca Académica</b></p>
                            <p>50% de Beca sobre colegiatura</p>
                      ...
                      <div class="col-xs-3" align="right">
                        <span class="glyphicon glyphicon-heart red" aria-hidden="true" align="right"></span>
                        <br><br><br><br><br><br><br>
                        <strong class="blue">40%</strong>
                      </div>
                    </div>

                    <div class="col-md-2 col-md-offset-1 caja-2">
                      <div class="col-xs-9 space-inside" align="left">
                        <a href="" data-toggle="modal" data-target="#tecmon"><span class="blue-box">U-ERRE</span></a>
                        <div class="space-inside-p">
                            <br>
                            <p><b>Beca Académica</b></p>
                            <p>50% de Beca sobre colegiatura</p>
