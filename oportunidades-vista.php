      ...
      <header>
        <div class="container space3">
           <div class="row">
             <div class="col-xs-12" align="center">
                ...
                <p>Todas estas becas estan a tu alcance, revisalas y marca tus favoritas para tenerlas en "mis becas".</p>
             </div>
           </div>
        </div>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-9">
                <div class="row">
                    <div class="col-md-12 caja-space caja-h-1">
                        <div class="row">
                          <div class="col-xs-1">
                ...
                <div class="row">
                    <div class="col-md-12 caja-space caja-h">
                        <div class="row">
                          <div class="col-xs-1">
                            <span class="glyphicon glyphicon-heart gray-box" aria-hidden="true" align="right"></span> 
                          </div>
                          <div class="col-xs-3 space-inside">
                            <span class="blue-box">Tec de Monterrey</span>
                          </div>
                          <div class="col-xs-4 space-inside">
                            <p class="dark-gray"><b>Beca Académica</b></p>
                          </div>
...
<div id="tecmon-heart" class="modal fade" role="dialog">
    <div class="modal-dialog">
